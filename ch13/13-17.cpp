...
int main() {
    ...
    binaryio.write(reinterpret_cast<char*>(&student1), sizeof(student1));
    binaryio.write(reinterpret_cast<char*>(&student2), sizeof(student2));
    binaryio.write(reinterpret_cast<char*>(&student3), sizeof(student3));
    binaryio.write(reinterpret_cast<char*>(&student4), sizeof(student4));
