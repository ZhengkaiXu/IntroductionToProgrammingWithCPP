...
int main()
{
    const int NUMBER_OF_PRIMES = 50; // Number of primes tp display
    const int NUMBER_OF_PRIMES_PRE_LINE = 10; // Display 10 per line
    ...
    while (count < NUMBER_OF_PRIMES) {
        ...
        if (isPrime) {
            ...
            if (count % NUMBER_OF_PRIMES_PRE_LINE == 0) {
                // Display hte number and advance to the new line
